...
const etapas = [
    ...
    {
        titulo: 'Wireframe',
        descricao: 'Desenho da estrutura visual do site, focando na experiência do usuário. Utiliznado Figma, Canva e Photoshop.',
...
export function About() {
    return (
        <>
            <ScrollProgress />
            <section
                className="bg-black text-white min-h-screen p-4 md:px-20 md:py-12 overflow-hidden"
            >
                <div className="h-full flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    <div className="flex flex-col items-start text-left max-w-3xl" data-aos="fade-right">
                        <h2
                            className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-purple-700 to-purple-400 animate-gradient-x mb-6"
                        >
                            Sobre mim
                        </h2>

                        <p className="text-lg leading-relaxed text-transparent bg-clip-text animate-gradient-flow bg-gradient-to-r from-purple-900 via-purple-500 to-purple-400 bg-[length:200%_200%]">
                        ...
                        <p className="mt-6 text-lg leading-relaxed text-transparent bg-clip-text animate-gradient-flow bg-gradient-to-r from-purple-900 via-purple-500 to-purple-400 bg-[length:200%_200%]">
                            ...
                            Se você busca um site que impressiona, comunica com clareza e atrai mais clientes, estou pronta para te ajudar. Vamos dar vida ao seu projeto?
                        </p>
                    </div>
                ...
                <div className="mt-20 w-full flex flex-col items-center py-12 px-4 bg-gradient-to-b from-black via-zinc-900 to-black text-white">
                    ...
                    <a
                        ...
                        data-aos="zoom-in-up"
                        data-aos-delay={etapas.length * 200}
                    >
                        Solicitar Orçamento
                    </a>
